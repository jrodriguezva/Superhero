...
import com.jrodriguezva.superhero.utils.extension.cancelTransition
import javax.inject.Inject

class SuperheroDetailsAnimator
@Inject constructor() {
    ...
    internal fun postponeEnterTransition(activity: androidx.fragment.app.FragmentActivity) =
